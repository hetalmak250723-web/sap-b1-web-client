const FORM_SETTINGS_STORAGE_KEY = 'sapb1.delivery.formSettings.v1';

const HEADER_UDF_DEFINITIONS = [
  { key: 'U_ShipmentNotes', label: 'Shipment Notes', type: 'text', defaultValue: '' },
  { key: 'U_DeliveryPriority', label: 'Delivery Priority', type: 'select', defaultValue: 'Normal', options: ['Low', 'Normal', 'High', 'Urgent'] },
  { key: 'U_ShipmentDate', label: 'Shipment Date', type: 'date', defaultValue: '' },
  { key: 'U_DeliveryInstructions', label: 'Delivery Instructions', type: 'textarea', defaultValue: '' },
];
