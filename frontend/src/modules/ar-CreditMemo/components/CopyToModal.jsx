    ...
    <div className="modal-overlay" onClick={handleClose}>
      <div className="modal-content" onClick={e => e.stopPropagation()} style={{ maxWidth: 600, width: '90%' }}>
        ...
        <div className="modal-body">
          ...
          {selectedType && (
            <div className="alert alert-info mt-3" style={{ fontSize: 13 }}>
              <strong>Note:</strong> This will create a new {selectedType === 'arInvoice' ? 'A/R Invoice' : 'Return'} document 
              with data from the current delivery. The new document will be linked to this delivery as a base document.
            </div>
          )}
        </div>
        ...
        <div className="modal-footer">
          ...
          >
            Copy To {selectedType === 'arInvoice' ? 'Invoice' : selectedType === 'return' ? 'Return' : 'Document'}
          </button>
        </div>
      </div>
    </div>
