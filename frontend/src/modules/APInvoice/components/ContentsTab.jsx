...
const MATRIX_COLS = [
  ...
  { key: 'openQty', label: 'Open Qty', minWidth: 70 },
                  ...
                  <td>
                    <div style={{ display: 'flex', gap: '2px', alignItems: 'center' }}>
                      ...
                      <button
                        ...
                        style={{ padding: '0 6px', fontSize: 11, border: '1px solid #a0aab4', background: 'linear-gradient(180deg, #fff 0%, #e8ecf0 100%)', minWidth: '24px', height: '22px', cursor: 'pointer', borderRadius: '2px' }}
                        title="Select Item"
                      >...</button>
                    </div>
