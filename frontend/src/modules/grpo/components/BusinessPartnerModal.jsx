...
export default function BusinessPartnerModal({ isOpen, onClose, onSelect, businessPartners }) {
                    ...
                    filteredPartners.map((bp, index) => (
                      ...
                      >
                        ...
                        <td style={{ padding: '3px 8px', textAlign: 'right', fontVariantNumeric: 'tabular-nums' }}>
                          {formatCurrency(bp.CurrentAccountBalance || bp.Balance || 0)}
                        </td>
                        <td style={{ padding: '3px 8px' }}>
                          {bp.CardType === 'C' ? 'Customer' : bp.CardType === 'S' ? 'Supplier' : bp.CardType === 'L' ? 'Lead' : bp.CardType || 'Supplier'}
                        </td>
                      </tr>
                    ))
                  )}
